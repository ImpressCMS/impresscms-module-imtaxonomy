 ...
 * @since		1.00
 * @version		$Id: link.php 19232 2010-05-09 10:49:34Z underdogg $
 * @package		module::tag
 */
...
defined("FRAMEWORKS_ART_FUNCTIONS_INI") || include_once XOOPS_ROOT_PATH.'/modules/'.basename(  dirname(  dirname( __FILE__ ) ) ).'/class/art/functions.ini.php';
load_object();
