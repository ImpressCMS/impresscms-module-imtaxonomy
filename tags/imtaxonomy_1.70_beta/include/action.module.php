 ...
 * @since		1.00
 * @version		$Id: action.module.php 19246 2010-05-10 10:19:05Z underdogg $
 * @package		module::tag
 */
...
function xoops_module_update_tag(&$module, $prev_version = null)
{
    ...
    if ($prev_version <= 150) {
        $GLOBALS['xoopsDB']->queryFromFile(ICMS_ROOT_PATH."/modules/".$module->getVar("dirname")."/sql/mysql.150.sql");
    }
