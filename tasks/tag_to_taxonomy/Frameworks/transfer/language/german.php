...
define("_MD_TRANSFER_DESC", "Zu anderen Anwendungen senden");
define("_MD_TRANSFER_DONE", "Die Operation wurde durchgeführt");
define("_MD_TRANSFER_MORE", "weitere Optionen");
?>