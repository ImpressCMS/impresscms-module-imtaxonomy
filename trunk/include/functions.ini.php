 ...
 * @since		1.00
 * @version		$Id: functions.ini.php 19246 2010-05-10 10:19:05Z underdogg $
 * @package		module::tag
 */
...
{
	if(!@include ICMS_ROOT_PATH."/modules/tag/language/".$GLOBALS["xoopsConfig"]["language"]."/config.php") {
		@include ICMS_ROOT_PATH."/modules/tag/language/english/config.php";
	}
