 ...
 * @since		1.00
 * @version		$Id: view.tag.php 19246 2010-05-10 10:19:05Z underdogg $
 * @package		module::tag
 */
...
if (empty($tag_id) && empty($tag_term) ) {
    redirect_header(ICMS_URL."/modules/".$GLOBALS["xoopsModule"]->getVar("dirname")."/index.php", 2, TAG_MD_INVALID);
	exit();
}
